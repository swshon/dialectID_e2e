...
for i in range(TOTAL_JOB):
    TFRECORDS_NAME = 'data/tfrecords/'+'mgb3_'+ tffilename +'_train.'+str(i)+'.tfrecords'
    write_tfrecords(feat,utt_label,utt_shape,TFRECORDS_NAME)
    feat, utt_label, utt_shape = do_shuffle(feat,utt_label,utt_shape)
    TFRECORDS_NAME = 'data/tfrecords/'+'mgb3_'+tffilename+'_train_shuffle.'+str(i)+'.tfrecords'
    write_tfrecords(feat,utt_label,utt_shape,TFRECORDS_NAME)
...
TOTAL_JOB = 1
for i in range(TOTAL_JOB):
    TFRECORDS_NAME = 'data/tfrecords/'+'mgb3_'+ tffilename +'_dev.'+str(i)+'.tfrecords'
    write_tfrecords(feat,utt_label,utt_shape,TFRECORDS_NAME)
    feat, utt_label, utt_shape = do_shuffle(feat,utt_label,utt_shape)
    TFRECORDS_NAME = 'data/tfrecords/'+'mgb3_'+tffilename+'_dev_shuffle.'+str(i)+'.tfrecords'
    write_tfrecords(feat,utt_label,utt_shape,TFRECORDS_NAME)
